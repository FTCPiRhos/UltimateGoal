...
//        static final int CB_CHAN_MASK_THRESHOLD = 80;
    ...
    {
        StoneOrientationAnalysisPipeline.StoneOrientation orientation;
        double angle;
        Point[] points;
    }
    ...
    ArrayList<StoneOrientationAnalysisPipeline.AnalyzedStone> internalStoneList = new ArrayList<>();
    volatile ArrayList<StoneOrientationAnalysisPipeline.AnalyzedStone> clientStoneList = new ArrayList<>();
    ...
    StoneOrientationAnalysisPipeline.Stage[] stages = StoneOrientationAnalysisPipeline.Stage.values();
    ...
    void analyzeContour(MatOfPoint contour, Mat input)
    {
        ...
        Point[] stonePoints = new Point[4];

        // Do a rect fit to the contour, and draw it on the screen
        RotatedRect rotatedRectFitToContour = Imgproc.minAreaRect(contour2f);
        drawRotatedRect(rotatedRectFitToContour, input);
        rotatedRectFitToContour.points( stonePoints );
        ...
        StoneOrientationAnalysisPipeline.ContourRegionAnalysis aboveMidlineMetrics = analyzeContourRegion(aboveMidline);
        StoneOrientationAnalysisPipeline.ContourRegionAnalysis belowMidlineMetrics = analyzeContourRegion(belowMidline);
        ...
        if(aboveMidlineMetrics.density < belowMidlineMetrics.density - DENSITY_UPRIGHT_THRESHOLD)
        {
            ...
            StoneOrientationAnalysisPipeline.AnalyzedStone analyzedStone = new StoneOrientationAnalysisPipeline.AnalyzedStone();
            analyzedStone.angle = angle;
            analyzedStone.orientation = StoneOrientationAnalysisPipeline.StoneOrientation.NOT_UPRIGHT;
        ...
        else
        {
            ...
            analyzedStone.orientation = StoneOrientationAnalysisPipeline.StoneOrientation.UPRIGHT;
            analyzedStone.points = stonePoints;
            internalStoneList.add(analyzedStone);
        }
    }
    ...
    static StoneOrientationAnalysisPipeline.ContourRegionAnalysis analyzeContourRegion(ArrayList<Point> contourPoints)
    {
        ...
        if(hullMatOfInt.toArray().length > 0)
        {
            ...
            StoneOrientationAnalysisPipeline.ContourRegionAnalysis analysis = new StoneOrientationAnalysisPipeline.ContourRegionAnalysis();
