...
public class OpenCVTestPipelineComp2 extends OpenCvPipeline
{

    public OpenCVTestPipelineComp2( boolean fLeft ) {
        fLeftPos = fLeft;
        if ( fLeftPos )
            REGION1_TOPLEFT_ANCHOR_POINT = new Point( 240, 170 );
        else
    ...
    final double FOUR_RING_THRESHOLD = 0.6;
    ...
    private volatile OpenCVTestPipelineComp2.RingPosition position = OpenCVTestPipelineComp2.RingPosition.FOUR;
    ...
    public Mat processFrame(Mat input)
    {
        ...
        position = OpenCVTestPipelineComp2.RingPosition.FOUR; // Record our analysis
        ...
        if ( ratio > FOUR_RING_THRESHOLD )
            position = OpenCVTestPipelineComp2.RingPosition.FOUR;
        else if ( ratio > ONE_RING_THRESHOLD )
            position = OpenCVTestPipelineComp2.RingPosition.ONE;
        else
            position = OpenCVTestPipelineComp2.RingPosition.NONE;
