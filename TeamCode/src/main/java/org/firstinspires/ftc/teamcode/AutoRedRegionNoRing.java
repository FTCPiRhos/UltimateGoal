...
@Autonomous(name="Auto Red Region no ring", group="PiRhos")

public class AutoRedRegionNoRing extends AutoBaseRegional {
    class SetRPMVars {
    ...
    private AutoRedRegionNoRing.SetRPMVars shooterRPMVars = new AutoRedRegionNoRing.SetRPMVars();
    ...
    private AutoRedRegionNoRing.MoveWPIDVars moveWPIDVars = new AutoRedRegionNoRing.MoveWPIDVars();
