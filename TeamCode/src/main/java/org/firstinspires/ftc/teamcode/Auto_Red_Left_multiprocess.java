...
/*
            if (objectFound.equals(OpenCVTestPipeline.RingPosition.NONE)) {
                ...
                flywheelShooter.setPower(flywheelPower * 1.085);
                moveWPID(7, 0, 0.5);
                ...
                for (int i = 0; i < 3; i += 1) {
                    ...
                    if (i == 0) flywheelShooter.setPower(flywheelPower * 1.08 * 1.15);

                    if (i == 1) flywheelShooter.setPower(flywheelPower * 1.08 * 1.15);
                    flywheelServo.setPosition(0.6);
                    sleep(350);
