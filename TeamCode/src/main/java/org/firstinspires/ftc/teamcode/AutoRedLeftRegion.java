...
public class AutoRedLeftRegion extends AutoBaseRegional {
    class SetRPMVars {
    ...
    private AutoRedLeftRegion.SetRPMVars shooterRPMVars = new AutoRedLeftRegion.SetRPMVars();
    ...
    private AutoRedLeftRegion.MoveWPIDVars moveWPIDVars = new AutoRedLeftRegion.MoveWPIDVars();
    // target shooter speed
    double targetRPMGoal = -169;
