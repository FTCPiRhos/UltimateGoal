...
//@Disabled
@Disabled public class OpenCvCrCbRedSide extends AutonBaseWebcamTest
{
    ...
    public void runOpMode()
    {
        ...
        {
            telemetry.addData("Y = ", pipeline.avg0);

            telemetry.addData("Cr = ", pipeline.avg1);
            telemetry.addData( "Cb = ", pipeline.avg2);
 ...
 */
    ...
    public static class OpenCVTestPipeline extends OpenCvPipeline
    {
        ...
        final double FOUR_RING_THRESHOLD = 0.4;
        final double ONE_RING_THRESHOLD = 0.1;
