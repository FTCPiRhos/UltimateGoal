...
@Autonomous(name="Auto Blue Region", group="PiRhos")

public class AutoBlueSide extends AutoBaseRegional {
    class SetRPMVars {
    ...
    private AutoBlueSide.SetRPMVars shooterRPMVars = new AutoBlueSide.SetRPMVars();
    ...
    private AutoBlueSide.MoveWPIDVars moveWPIDVars = new AutoBlueSide.MoveWPIDVars();
