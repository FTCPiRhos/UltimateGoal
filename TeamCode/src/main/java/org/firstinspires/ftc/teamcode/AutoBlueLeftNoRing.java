...
@Autonomous(name="Auto Blue Region no ring", group="PiRhos")

public class AutoBlueLeftNoRing extends AutoBaseRegional {
    class SetRPMVars {
    ...
    private AutoBlueLeftNoRing.SetRPMVars shooterRPMVars = new AutoBlueLeftNoRing.SetRPMVars();
    ...
    private AutoBlueLeftNoRing.MoveWPIDVars moveWPIDVars = new AutoBlueLeftNoRing.MoveWPIDVars();
